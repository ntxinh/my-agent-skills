#!/usr/bin/env bash
# resolve_config.sh — resolve azure-cache-redis config for a given environment.
#
# Usage:
...
#      <git-root>/.claude/azure-cache-redis.json
...
SKILL_NAME="azure-cache-redis"
REQUIRED_FIELDS=(subscriptionId resourceGroup cacheName hostName)
OPTIONAL_DEFAULTS='{"port": 6380}'
