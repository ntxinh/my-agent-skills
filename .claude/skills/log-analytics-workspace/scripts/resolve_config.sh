#!/usr/bin/env bash
#
# resolve_config.sh — resolve Log Analytics Workspace config for the
...
#
# Resolution order:
#   1. <git-root>/.claude/log-analytics-workspace.json   (project-specific override)
#   2. ~/.claude/log-analytics-workspace.json            (personal/global default)
#
...
SKILL_NAME="log-analytics-workspace"
REQUIRED_FIELDS=("subscriptionId" "resourceGroup" "logAnalyticsWorkspaceName")
